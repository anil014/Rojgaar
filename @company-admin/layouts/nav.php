...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-nav navbar-left navbar-top-links">
        <li><a href="#"><i class="fa fa-home fa-fw"></i>Rojgaar</a></li>
    </ul>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?=URL('@company-admin')?>" class="active"><i class="fa fa-dashboard fa-fw"  style="color:green"></i> Dashboard</a>
                </li>
                <li><a href="<?=URL('@company-admin/post-jobs')?>">
                        <i class="fa fa-gear fa-plus"  style="color:green"></i> Post Jobs</a>
                </li>
                <li><a href="<?=URL('@company-admin/show-post-jobs')?>">
                        <i class="fa fa-gear fa-eye"  style="color:green"></i> Show Jobs</a>
                </li>

                <li><a href="<?=URL('@company-admin/show_apply_jobs')?>">
                        <i class="fa fa-envelope"  style="color:green"></i> Show Apply Jobs</a>
                </li>
