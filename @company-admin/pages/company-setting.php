                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_name" style="color:green">Company Name</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_address" style="color:green">Company Address</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_contact"  style="color:green">Contact Number</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_optional_contact_number"  style="color:green">Optional Contact
                                    Number</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_email"  style="color:green">Email</label>
                                <input type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_username"  style="color:green">User name</label>
                                <input type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="company_website"  style="color:green">Website</label>
                                <input type="text"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="change_image"  style="color:green">Company logo</label>
